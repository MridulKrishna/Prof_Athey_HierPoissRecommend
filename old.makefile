...
main.o: main.cc env.hh hgaprec.hh log.hh
	g++ -c main.cc -I. -I/usr/local/include -I/opt/local/include
	
hgaprec.o: hgaprec.cc env.hh hgaprec.hh ratings.hh gpbase.hh
	g++ -c hgaprec.cc -I. -I/usr/local/include -I/opt/local/include
	
log.o: log.cc log.hh
	g++ -c log.cc -I. -I/usr/local/include -I/opt/local/include
	
ratings.o: ratings.hh log.hh matrix.hh env.hh
	g++ -c ratings.cc -I. -I/usr/local/include -I/opt/local/include
